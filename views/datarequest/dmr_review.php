    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header clearfix">
                <a class="btn btn-secondary float-left collapse-buttons" data-toggle="collapse" href="#datamanagerReviewDiv" role="button" aria-expanded="true">
            ...
            <div id="datamanagerReviewDiv" class="card-body collapse show">
...
<script src="/datarequest/static/js/datarequest/dmr_review.js" type="text/javascript"></script>
